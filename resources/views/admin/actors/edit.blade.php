                            ...
                            <div class="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                                <label class="flex items-center">
                                    <input type="checkbox" name="teaching_schools[]" value="{{ $school->id }}"
                                        ...
                                        class="rounded text-blue-600 focus:ring-blue-500 teaching-school-checkbox">
                                ...
                                <div class="teaching-school-fields ml-4 {{ in_array($school->id, $currentTeachingSchools ?? []) ? '' : 'hidden' }}">
                                    ...
                                    <textarea name="teaching_bios[{{ $school->id }}]"
                                        ...
                                        class="border border-gray-300 rounded px-3 py-1 text-sm w-48 ml-2">{{ $actor->teachingSchools->firstWhere('id', $school->id)?->pivot?->teaching_bio }}</textarea>
                                </div>
                            </div>
                            @endforeach
                        </div>
