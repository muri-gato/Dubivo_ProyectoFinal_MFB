        ...
        <div class="border-b border-gray-200 pb-4 mb-6">
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-gray-500">
                    ID: <?php echo e($work->id); ?> • Creada: <?php echo e($work->created_at->format('d/m/Y')); ?>
        ...
        <div class="bg-gray-50 p-4 mb-6 border border-gray-200">
            ...
            <div class="grid grid-cols-2 gap-4 text-sm">
                <div>
                    ...
                    <span class="ml-2"><?php echo e($work->actors_count); ?></span>
                </div>
                <div>
                    <span class="font-medium">Última actualización:</span>
                    <span class="ml-2"><?php echo e($work->updated_at->format('d/m/Y H:i')); ?></span>
                </div>
