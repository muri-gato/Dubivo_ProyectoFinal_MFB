    ...
    <?php if ($school->teachers->count() > 0): ?>
        ...
        <div class="bg-white shadow-md p-6 mb-6 border border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <?php $__currentLoopData = $school->teachers;
                $__env->addLoop($__currentLoopData);
                foreach ($__currentLoopData as $teacher): $__env->incrementLoopIndices();
    ...
    <div class="bg-white shadow-md p-6 border border-gray-200">
        ...
        <?php if ($school->actors->count() > 0): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <?php $__currentLoopData = $school->actors;
                $__env->addLoop($__currentLoopData);
                foreach ($__currentLoopData as $actor): $__env->incrementLoopIndices();
                    $loop = $__env->getLastLoop(); ?>
