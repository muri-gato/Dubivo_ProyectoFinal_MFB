    ...
    <header class="bg-negro text-white shadow-lg">
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <!-- Logo a la izquierda -->
                <a href="<?php echo e(Auth::check() ? route('dashboard') : url('/')); ?>"
                ...
                <nav class="flex items-center">
                    ...
                    <div class="relative">
                        ...
                        <div id="user-menu" class="absolute right-0 mt-2 w-48 bg-white shadow-xl py-2 hidden z-50 border border-gray-200">
                            ...
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-2 text-gray-800 hover:bg-gray-100 text-sm font-medium transition-colors duration-200">
                            ...
                            <?php else: ?>
                            <a href="<?php echo e(route('actors.create')); ?>" class="block px-4 py-2 text-gray-800 hover:bg-gray-100 text-sm font-medium transition-colors duration-200">
                    ...
                    <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-white hover:text-ambar px-3 py-2 text-sm font-semibold transition-colors duration-300">
                        Iniciar Sesión
                    </a>
