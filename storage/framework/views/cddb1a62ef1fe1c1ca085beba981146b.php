...
<?php $__env->startSection('title', $actor->name . ' - Dubivo'); ?>

<?php $__env->startSection('content'); ?>
<div class="container mx-auto px-4 py-8">
    <!-- Navegación -->
    <div class="mb-6">
        <a href="<?php echo e(route('actors.index')); ?>" class="text-blue-600 hover:text-blue-800 font-semibold">
    ...
    <div class="flex flex-col">
        ...
        <div class="w-full">
            ...
            <div class="bg-white shadow-md p-6 mb-6 border border-gray-200">
                ...
                <p class="text-gray-700 leading-relaxed"><?php echo e($actor->bio); ?></p>
            </div>
            <?php endif; ?>

            <!-- Escuelas -->
            <?php if($actor->schools->count() > 0): ?>
            <div class="bg-white shadow-md p-6 mb-6 border border-gray-200">
                <h2 class="text-2xl font-bold mb-4 text-gray-800">Formación</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <?php $__currentLoopData = $actor->schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border border-gray-200 p-4 hover:bg-gray-50 transition duration-200">
                        <h3 class="font-semibold text-lg text-blue-600"><?php echo e($school->name); ?></h3>
                        <p class="text-gray-600"><?php echo e($school->city); ?></p>
                        <a href="<?php echo e(route('schools.show', $school)); ?>" class="text-blue-600 hover:text-blue-800 hover:underline mt-2 inline-block font-semibold">
                            Ver escuela
                        </a>
                    </div>
            ...
            <div class="bg-white shadow-md p-6 border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php $__currentLoopData = $actor->works; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $work): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border border-gray-200 p-4 hover:bg-gray-50 transition duration-200">
                        <h3 class="font-semibold text-lg text-purple-600"><?php echo e($work->title); ?></h3>
                        <p class="text-gray-600 capitalize"><?php echo e($work->type); ?> <?php if($work->year): ?>(<?php echo e($work->year); ?>)<?php endif; ?></p>
                        <?php if($work->pivot->character_name): ?>
                        <p class="text-sm text-purple-600"><strong>Personaje:</strong> <?php echo e($work->pivot->character_name); ?></p>
                        <?php endif; ?>
                        <a href="<?php echo e(route('works.show', $work)); ?>" class="text-purple-600 hover:text-purple-800 hover:underline mt-2 inline-block font-semibold">
                            Ver obra
                        </a>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mt-3 text-center">
            ...
            <div class="mt-2 px-7 py-3">
                <p class="text-sm text-gray-500">
                    Para contactar a <span class="font-semibold text-blue-600"><?php echo e($actor->name); ?></span> necesitas una cuenta de cliente.
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Programas\laragon\www\ProyectoFinalMFB\resources\views/actors/show.blade.php ENDPATH**/ ?>