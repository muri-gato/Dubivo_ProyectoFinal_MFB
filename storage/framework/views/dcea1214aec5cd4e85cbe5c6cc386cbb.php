...
<?php $__env->startSection('title', 'Panel de Administración - Dubivo'); ?>
        ...
        <div class="bg-white shadow-md p-6 border border-gray-200 border-l-4 border-naranja-vibrante">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_actors']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-md p-6 border border-gray-200 border-l-4 border-rojo-intenso">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_admins']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-md p-6 border border-gray-200 border-l-4 border-verde-menta">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_schools']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-md p-6 border border-gray-200 border-l-4 border-azul-profundo">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_works']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-md p-6 border border-gray-200 border-l-4 border-morado-vibrante">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_teacher_actors']); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Programas\laragon\www\ProyectoFinalMFB\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>